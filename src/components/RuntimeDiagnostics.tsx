...
export function RuntimeDiagnostics() {
  ...
  return <section aria-label="Runtime diagnostics">
    <div className="form-footer"><h2>Runtime log</h2><button className="secondary" disabled={!nativeAvailable || busy} onClick={() => setRevision(value => value + 1)}>{busy ? 'Reading…' : 'Refresh log'}</button></div>
