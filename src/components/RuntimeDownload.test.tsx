...
vi.mock('../lib/api', () => ({ nativeAvailable: true, errorMessage: String, api: { runtimeDownloadInfo: fixtures.info, runtimeInstallStatus: fixtures.status, installRuntime: fixtures.install } }));
