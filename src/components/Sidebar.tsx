import { BookOpen, Boxes, Brain, Cpu, MessageSquare, PanelLeftClose, Plug, Plus, Search, Sun, Moon, Terminal } from 'lucide-react';
import type { Conversation } from '../lib/types';
export type Page = 'chat' | 'models' | 'connectors' | 'skills' | 'execution' | 'memory' | 'plugins';
interface Props {
